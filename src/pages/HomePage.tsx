            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    percentage: "64.4%",
                    percentageValue: 64.4,
                    name: "BLUR PHISHING AI",
                    description: "Identifies wallets that have been associated with fraudulent coins or rugpulls"
                  },
                  {
                    percentage: "70.4%",
                    percentageValue: 70.4,
                    name: "BLUR RUG CHECK AI",
                    description: "Rates Rugpull probability"
                  }
                ].map((ai, index) => (
                  <div key={index} className="group bg-gradient-to-br from-neutral-900/50 to-neutral-800/30 border border-neutral-800/40 p-6 rounded-xl backdrop-blur-sm hover:border-blue-500/40 transition-all duration-500 hover:shadow-lg hover:shadow-blue-500/10 hover:scale-[1.02] transform">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <div className="text-3xl font-bold text-blue-400 group-hover:text-blue-300 transition-colors duration-300">{ai.percentage}</div>
                    ...
                    <div className="mb-4">
                      <div className="w-full bg-neutral-800/50 rounded-full h-2 overflow-hidden">
                        <div 
                          className="h-full bg-gradient-to-r from-blue-500 to-blue-400 rounded-full transition-all duration-1000 ease-out shadow-lg shadow-blue-500/30"
                          style={{ width: `${ai.percentageValue}%` }}
                        >
              ...
              <div className="relative bg-gradient-to-br from-neutral-900/30 to-neutral-800/20 border border-neutral-800/30 p-12 rounded-2xl backdrop-blur-sm">
                <div className="grid grid-cols-3 gap-6">
                  ...
                  {Array.from({ length: 9 }).map((_, index) => (
                    <div key={index} className="w-12 h-12 bg-gradient-to-br from-neutral-800/40 to-neutral-700/20 border border-neutral-700/30 flex items-center justify-center hover:border-blue-500/30 transition-all duration-500 rounded-lg hover:scale-110 transform hover:shadow-lg hover:shadow-blue-500/10">
                ...
                <div className="absolute inset-0 pointer-events-none">
                  <svg className="w-full h-full opacity-20">
                    ...
                    {Array.from({ length: 9 }).map((_, index) => {
                      const angle = (index * 40) - 160; // Distribute around circle
                      const radius = 30;
